...
var HappyForm = React.createClass({
  ...
  handlePhraseChange: function() {
    ...
    handleSubmit: function() {
      ...
      var phrase = this.state.phrase.trim();
      var img = this.state.img.trim();
      
    },
  render: function(){
    return (
      <form className="happyform">
        <input type="text" placeholder="Who said it" value={this.state.name} onChange={this.handleNameChange} />
        <input type="text" placeholder="Happy Saying" value={this.state.phrase} onChange={this.handlePhraseChange} />
        <input type="text" placeholder="Image to Go With It" value={this.state.img} onChange={this.handleImgChange} />
        <input type="submit" value="Post to Happy" />
      </form>
      )
  }
});
...
var HappyCardList = React.createClass({
...
ReactDOM.render(<App></App>, document.getElementById('happy5'))
